...
<tr>
<th align="left" style="height:5%;font-size:20px;">My Loyalty Bonus</th>
</tr>
<tr>
...
<?php
	...
	$points = $totalamount/10; ?>
	<tr>
	<td>Total Loyalty Bonus - <?php echo $points?> Points</td>
	</tr>
	<tr>
    <td>&nbsp;</td>
    </tr>
    ...
    <td bgcolor="#183EA5" align="right" colspan="2"><button class="btn" onclick="window.location.href='members.php?view=myLoyaltyBonus&add=true&N=<?php echo $info['No.']?>'"><font color="white">Add to WishList</font></button></td>
    </tr>
    <tr>
    ...
    <td style="width:100%;height:100%;">
        ...
        <tr>
        <td align="center">Points:&nbsp;<?php echo $info['Price']/10?></td>
        </tr>
        <tr>
	...
	while($info = mysql_fetch_array( $check )) {
		...
		if ($check3 == 0) {
			...
			VALUES (NULL, '".$info['Name']."', '".base64_encode($info['Image'])."', '".$info['Price']."'
					, '".$info['Details']."', '0', '".$username."')";
			$add_member = mysql_query($insert) or die(mysql_error());
			echo "<script language=\"JavaScript\">\n";
			echo "alert('The Product is added to your WishList!');\n";
			echo "window.location='members.php?view=myLoyaltyBonus'";
			echo "</script>";
			die();
		}
		else {
